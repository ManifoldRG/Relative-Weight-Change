...
def load_fashionmnist(configs):
    ...
    # load datasets, downloading if needed
    train_set = FashionMNIST('/tmp', train=True, download=True,
                        transform=train_transforms)
    test_set = FashionMNIST('/tmp', train=False, download=True,
                       transform=test_transforms)
...
def load_mnist(configs):
    ...
    # load datasets, downloading if needed
    train_set = MNIST('/tmp', train=True, download=True,
                        transform=train_transforms)
    test_set = MNIST('/tmp', train=False, download=True,
                       transform=test_transforms)
